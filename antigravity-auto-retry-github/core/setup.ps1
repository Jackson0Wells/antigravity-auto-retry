...
function Create-UserShortcuts {
    ...
    $startMenuFolder = Join-Path $programs "Antigravity Auto Retry"
    New-Item -ItemType Directory -Force -Path $startMenuFolder | Out-Null

    $icon = $IdePath
    if (-not (Test-Path $icon)) { $icon = "powershell.exe,0" } else { $icon = "$icon,0" }

    if ($RunHidden) {
        $launcher = Join-Path $scriptDir "launch_ide_and_retry_hidden.vbs"
    } else {
        $launcher = Join-Path $scriptDir "launch_ide_and_retry.bat"
    }

    $rootDir = Split-Path -Parent $scriptDir
    New-Shortcut -ShortcutPath (Join-Path $desktop "Antigravity IDE with Auto Retry.lnk") -TargetPath $launcher -IconPath $icon
    New-Shortcut -ShortcutPath (Join-Path $startMenuFolder "Antigravity IDE with Auto Retry.lnk") -TargetPath $launcher -IconPath $icon
    New-Shortcut -ShortcutPath (Join-Path $startMenuFolder "Setup Antigravity Auto Retry.lnk") -TargetPath (Join-Path $rootDir "Setup Antigravity Auto Retry.vbs") -IconPath "powershell.exe,0"
}
...
function Remove-UserShortcuts {
    ...
    Remove-Item (Join-Path $desktop "Antigravity IDE with Auto Retry.lnk") -Force -ErrorAction SilentlyContinue
...
$form.ClientSize = New-Object System.Drawing.Size(610, 290)
...
$shortcutCheckbox.Text = "Create Desktop and Start Menu shortcuts"
$shortcutCheckbox.AutoSize = $true
$shortcutCheckbox.Location = New-Object System.Drawing.Point(20, 212)
$shortcutCheckbox.Checked = $InstallMode
...
$uninstallButton.Location = New-Object System.Drawing.Point(20, 246)
$uninstallButton.Size = New-Object System.Drawing.Size(130, 32)
$form.Controls.Add($uninstallButton)

$saveButton = New-Object System.Windows.Forms.Button
$saveButton.Text = "Save"
$saveButton.Location = New-Object System.Drawing.Point(316, 246)
$saveButton.Size = New-Object System.Drawing.Size(84, 32)
$form.Controls.Add($saveButton)

$saveStartButton = New-Object System.Windows.Forms.Button
$saveStartButton.Text = "Save and Start"
$saveStartButton.Location = New-Object System.Drawing.Point(408, 246)
$saveStartButton.Size = New-Object System.Drawing.Size(108, 32)
$form.Controls.Add($saveStartButton)

$cancelButton = New-Object System.Windows.Forms.Button
$cancelButton.Text = "Cancel"
$cancelButton.Location = New-Object System.Drawing.Point(524, 246)
...
$saveAction = {
    ...
    if ($shortcutCheckbox.Checked) {
        Create-UserShortcuts -IdePath $idePath -RunHidden $runHiddenCheckbox.Checked
    }
